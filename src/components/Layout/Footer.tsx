        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              ...
              We curate the best products to elevate your lifestyle.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/auth" className="text-gray-300 hover:text-white transition-colors">Account</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/products?category=Electronics" className="text-gray-300 hover:text-white transition-colors">Electronics</a></li>
              <li><a href="/products?category=Clothing" className="text-gray-300 hover:text-white transition-colors">Clothing</a></li>
